...
void compare( ) //previous 
{
 
	 const char* file0 = "HcalRespCorrs_2017plan1_v6.0_data.txt"; //new
	 const char* file1 = "HcalRespCorrs_2017plan1_v5.0_data.txt"; //pre
  ...
  for (int j=0; j<99999; j++) {
	...
	fscanf(ft0, "%d%d%d%s%f%s\r", &ieta1, &iphi1, &depth1, SubDet1, &c1, DetID1);

	  if (SubDet1[1] == 'B') {
		  if (depth1 == 1) hHB_d1->Fill(ieta1, iphi1, c1);
		  if (depth1 == 2) hHB_d2->Fill(ieta1, iphi1, c1);
	  }
	  if (SubDet1[1] == 'O') {
		  if (depth1>0)hHO_d1->Fill(ieta1, iphi1, c1);
	  }
	 
	  if (SubDet1[1] == 'E') {
		  if (depth1 == 1)hHE_d1->Fill(ieta1, iphi1, c1);
		  if (depth1 == 2)hHE_d2->Fill(ieta1, iphi1, c1);
		  if (depth1 == 3)hHE_d3->Fill(ieta1, iphi1, c1);
		  if (depth1 == 4)hHE_d4->Fill(ieta1, iphi1, c1);
		  if (depth1 == 5)hHE_d5->Fill(ieta1, iphi1, c1);
		  if (depth1 == 6)hHE_d6->Fill(ieta1, iphi1, c1);
		  if (depth1 == 7)hHE_d7->Fill(ieta1, iphi1, c1);
	  }
	  if (SubDet1[1] == 'F') {
		  if (depth1 == 1)hHF_d1->Fill(ieta1, iphi1, c1);
		  if (depth1 == 2)hHF_d2->Fill(ieta1, iphi1, c1);
		  if (depth1 == 3)hHF_d3->Fill(ieta1, iphi1, c1);
		  if (depth1 == 4)hHF_d4->Fill(ieta1, iphi1, c1);
	  }
  }
  ...
  for (int k = 0; k<99999; k++) {
	  ...
	  fscanf(ft1, "%d%d%d%s%f%s\r", &ieta2, &iphi2, &depth2, SubDet2, &c2, DetID2);
